        ...
        if (BotPlus.contains(event.getAuthor().getId())) {
            if (event.getMessage().getMentionedMembers().size() == 1) {
                ...
                channel.sendMessage(new EmbedBuilder()
                        ...
                        .setDescription("Du wurdest vom " + event.getGuild().getName() + " Server gebannt.")
                ...
                event.getTextChannel().sendMessage(new EmbedBuilder()
                        ...
                        .setDescription("Ich habe erfolgreich " + event.getMessage().getMentionedMembers().get(0).getUser().getName() + " \"gebannt\".")
