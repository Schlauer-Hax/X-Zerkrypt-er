...
public class HelpCommand implements Command {
    ...
    public void action(String[] args, MessageReceivedEvent event) {
        event.getTextChannel().sendMessage(new EmbedBuilder()
                ...
                .addField("?userkick @Skidder#6775", "Sendet einem Benutzer eine Kick Nachricht", true)
                .addField("?userban @Skidder#6775", "Sendet einem Benutzer eine Ban Nachricht", true)
